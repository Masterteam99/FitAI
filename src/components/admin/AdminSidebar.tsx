...
import { Users, CreditCard, Dumbbell, BarChart3, ShieldCheck, Bot, History, MessageSquare, Apple, ListChecks, Type, ClipboardList, UtensilsCrossed, Carrot, Trophy } from "lucide-react";
...
const ADMIN_TABS = [
  ...
  { href: "/admin/foods", label: copy.adminSidebar.tabFoods, icon: Carrot },
  { href: "/admin/quiz", label: copy.adminSidebar.tabQuiz, icon: ListChecks },
  { href: "/admin/leaderboard-rewards", label: copy.adminSidebar.tabLeaderboard, icon: Trophy },
