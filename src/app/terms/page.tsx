...
export const metadata: Metadata = { title: copy.terms.meta.title };
  ...
  return (
    <div className="theme-organic min-h-screen bg-background text-foreground p-4 py-10">
      <article className="max-w-3xl mx-auto space-y-6">
        ...
        <header>
          <h1 className="text-3xl font-bold">{copy.terms.title}</h1>
          <p className="text-sm text-muted-foreground mt-2">{copy.terms.lastUpdated}</p>
        </header>

        {copy.terms.sections.map((section, i) => (
