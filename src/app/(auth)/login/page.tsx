    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Accedi al tuo account FitAI</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <Input className="pl-9" type="password" placeholder="••••••••" {...register("password")} />
              </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          Non hai un account?{" "}
          <Link href="/registrati" className="text-primary hover:underline font-medium">Registrati gratis</Link>
        </p>
      </div>
    </div>
  );
